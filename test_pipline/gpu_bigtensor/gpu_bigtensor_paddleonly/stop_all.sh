...
PYTHON_CMD_PATTERN="python engine.py --api_config_file=test_pipline/gpu_bigtensor/gpu_bigtensor_paddleonly/gpu_bigtensor_paddleonly_errorconfig_([1-8])+\.txt --paddle_only=True"
