...
PYTHON_CMD_PATTERN="python engine.py --api_config_file=test_pipline/gpu_0size/gpu_0size_paddleonly/0sizetensor_paddleonly_(1[0-9]|[1-9]|2[0-4])+\.txt --paddle_only=True"
