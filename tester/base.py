...
class APITestBase:
    ...
    def need_skip(self):
        if "sparse." in self.api_config.api_name:
            return True
        if self.api_config.api_name in ["paddle.Tensor.coalesce", "paddle.Tensor.is_coalesced", "paddle.gather", "paddle.Tensor.gather", "paddle.index_select", "paddle.Tensor.index_select", "paddle.Tensor.index_put", "paddle.Tensor.index_sample", "paddle.index_put", "paddle.index_sample"]:
            return True
