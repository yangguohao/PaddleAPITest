...
if __name__ == '__main__':
    ...
    with open("/host_home/wanghuan29/APItest/PaddleAPITest/tester/api_config/8_big_tensor/big_tensor_1_1.txt", "w") as f:
        for api_config in tqdm(api_configs):
            ...
            for api_config in to_big_tensor_config(api_config):
